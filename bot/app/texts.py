...
# Stage 12 — Smart-routing / Config flow
CONFIG_DISABLED = (
    "Выдача конфига временно недоступна. Попробуй позже."
)

CONFIG_NO_SUB = (
    "Нет активной подписки. Активируй код или получи триал из главного меню."
)

CONFIG_PROMPT = (
    "🛠 Настройки маршрутизации\n\n"
    "Выбери режим:\n"
    "• <b>Всё-в-одном</b> — RU-сайты напрямую + блок рекламы + VPN для остального.\n"
    "• <b>Умный</b> — RU-сайты напрямую, остальное через VPN.\n"
    "• <b>Только AdBlock</b> — без обхода, только блок рекламы.\n"
    "• <b>Обычный</b> — весь трафик через VPN (как раньше)."
)

CONFIG_PROFILE_LABEL = {
    "full": "🛡 Всё-в-одном",
    "smart": "🧭 Умный (RU direct)",
    "adblock": "🚫 Только AdBlock",
    "plain": "🌐 Обычный VPN",
}

CONFIG_PROFILE_SET = (
    "✅ Профиль установлен: <b>{label}</b>\n\n"
    "Скачать конфиг:\n"
...
CONFIG_PROFILE_SET_NO_LINK = (
    "✅ Профиль установлен: <b>{label}</b>\n\n"
    "Ссылка на скачивание конфига появится после настройки sub-Worker."
)

CONFIG_API_ERROR = "Не удалось применить профиль: {message}"
